...
Resuming restores the transcript into Claude Code's project dir if auto-cleanup
...
Removing a session deletes its registry entry, preserved transcript, and summary
(it does **not** touch Claude Code's own live transcript).
